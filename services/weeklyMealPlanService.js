...
const plan = async () => {
  try {
    const prompt = `Provide dinner options and a snack for the kids for Monday through Friday. 
      About half of the time the dinner should be Mediterranean diet, 25% Chinese, and then an even distribution across the other cusine types.
